...
export const siteContent: Localized<Record<SitePage, Record<string, string>>> =
  {
    en: {
      ...
      whereToBuy: {
        ...
        availabilityTitle: "FIND RAYA\nNEAR YOU.",
        note: "Retail availability and store locations are being prepared.",
      },
    },
    ru: {
      story: {
      ...
      whereToBuy: {
        ...
        availability: "ГДЕ НАЙТИ",
        availabilityTitle: "НАЙДИТЕ RAYA\nРЯДОМ С ВАМИ.",
        note: "Информация о магазинах и наличии RAYA скоро появится.",
      },
    },
    uz: {
      story: {
      ...
      whereToBuy: {
        ...
        availabilityTitle: "RAYA'NI\nYAQININGIZDAN TOPING.",
        note: "RAYA sotiladigan do‘konlar va mavjudlik haqidagi ma’lumotlar tez orada paydo bo‘ladi.",
      },
    },
  };
